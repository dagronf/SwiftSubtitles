...
"""
		...
		XCTAssertEqual(srt.cues[0].startTimeInSeconds, 300.4, accuracy: 0.001)
		XCTAssertEqual(srt.cues[0].endTime, Subtitles.Time(minute: 5, second: 15, millisecond: 300))
		XCTAssertEqual(srt.cues[0].endTimeInSeconds, 315.3, accuracy: 0.001)

		XCTAssertEqual(srt.cues[1].text, "This is an example of\na subtitle - 2nd subtitle.")
		XCTAssertEqual(srt.cues[1].startTimeInSeconds, 316.4, accuracy: 0.001)
		XCTAssertEqual(srt.cues[1].endTimeInSeconds, 325.3, accuracy: 0.001)
...
"""
		...
		XCTAssertEqual(srt.cues[0].startTimeInSeconds, 3.4, accuracy: 0.0001)
		XCTAssertEqual(srt.cues[0].endTimeInSeconds, 6.177, accuracy: 0.0001)
		XCTAssertEqual(srt.cues[0].text, "In this lesson, we're going to\nbe talking about finance. And")
		XCTAssertEqual(srt.cues[1].startTimeInSeconds, 6.177, accuracy: 0.0001)
		XCTAssertEqual(srt.cues[1].endTimeInSeconds, 10.009, accuracy: 0.0001)
		XCTAssertEqual(srt.cues[1].text, "one of the most important aspects\nof finance is interest.")
		XCTAssertEqual(srt.cues[2].startTimeInSeconds, 10.009, accuracy: 0.0001)
		XCTAssertEqual(srt.cues[2].endTimeInSeconds, 13.655, accuracy: 0.0001)
...
//		난 아직 볼일이 남았다고!
		...
		XCTAssertEqual(s1.startTimeInSeconds, 869.84, accuracy: 0.0001)
		XCTAssertEqual(s1.endTimeInSeconds, 871.08, accuracy: 0.0001)
...
//		내가 좀 웃겼지!
		...
		XCTAssertEqual(e.startTimeInSeconds, 5266.72, accuracy: 0.0001)
		XCTAssertEqual(e.endTimeInSeconds, 5267.926, accuracy: 0.0001)
