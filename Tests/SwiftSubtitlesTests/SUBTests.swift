...
final class SUBTests: XCTestCase {
	...
	func testBasic() throws {
		...
		do {
			...
			XCTAssertEqual(1, subtitles.cues.count)
			XCTAssertEqual(subtitles.cues[0].text, "Hello!\nHow are you?")
			XCTAssertEqual(subtitles.cues[0].startTime.timeInSeconds, (0.0 / 60.0), accuracy: 0.001)
			XCTAssertEqual(subtitles.cues[0].endTime.timeInSeconds, (25.0 / 60.0), accuracy: 0.001)
		}
	}
	...
	func testSUBFile() throws {
		...
		XCTAssertEqual(subtitles.cues[475].startTime.timeInSeconds, (109504.0 / coder.framerate), accuracy: 0.001)
		XCTAssertEqual(subtitles.cues[475].endTime.timeInSeconds, (109602.0 / coder.framerate), accuracy: 0.001)
	}
}
